        ...
        <nav class="offcanvas-navigation" id="offcanvas-navigation">
            <ul>
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Home Samples 01</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Home Samples 02</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Home Samples 03</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Home Samples 04</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Sample Pages 01</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Sample Pages 02</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Sample Pages 03</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Sample Pages 04</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Portfolio Samples 02</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Portfolio Details 01</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Portfolio Details 02</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                ...
                <li class="menu-item-has-children">
                    <nuxt-link to="/">Elements</nuxt-link>
                    <ul class="sub-menu">
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Element Group 01</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Element Group 02</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Element Group 03</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Element Group 04</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Blog Group 01</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Blog Group 02</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Blog Group 03</nuxt-link>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="mega--title menu-item-has-children">
                            <nuxt-link to="">Blog Group 04</nuxt-link>
                            <ul class="sub-menu">
                                <li>
