                        ...
                        <div class="port-overlay-info">
                            <div class="hover-action">
                                <h3 class="post-overlay-title">
                                    <nuxt-link to="/portfolio/portfolio-details">A Golden Age of Design</nuxt-link>
                                </h3>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="portfolio-cation wow move-up">
                                ...
                                <div class="port-overlay-info">
                                    <div class="hover-action">
                                        <h3 class="post-overlay-title">
                                            <nuxt-link to="/portfolio/portfolio-details">Web Comic Landscape</nuxt-link>
                                        </h3>
                                        <div class="category">Design</div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="portfolio-cation wow move-up">
                                ...
                                <div class="port-overlay-info">
                                    <div class="hover-action">
                                        <h3 class="post-overlay-title">
                                            <nuxt-link to="/portfolio/portfolio-details">Website Success Prospects</nuxt-link>
                                        </h3>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="portfolio-cation wow move-up">
                                ...
                                <div class="port-overlay-info">
                                    <div class="hover-action">
                                        <h3 class="post-overlay-title">
                                            <nuxt-link to="/portfolio/portfolio-details">New Age Design</nuxt-link>
                                        </h3>
