        ...
        <footer class="bk-footer-area plr--100 plr_sm--10">
            <div class="copyright-area pb--45">
                <div class="copyright-right text-center text-md-end">
                    <p class="bk_pra heading-font2 color-dark">&copy; 2023 <b>Brook</b> Made with <i class="fa fa-heart text-danger"></i> by <a href="https://hasthemes.com/"><b>HasThemes</b></a></p>
                </div>
            </div>
        </footer>
    </div>
